...
import com.xcd.own.netdisk.client.operation.filesend.ClientSendFile;
...
public class MainJFrame extends JFrame {
    ...
    public FileInfoModel fim;
        ...
        public void updateUserInfo(String online) {
            ...
            SendBean csbUpdate = new SendBean(null, 0, "updateUserInfo", username, ip, online);

            //接收验证结果
            ReceiveBean crb = new ReceiveBean("updateUserInfo", null,
                    null, this, csbUpdate);
        }
        ...
        private void downloadButtonActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            // 将文件信息传递给ClientBean
            SendBean csb = new SendBean(ip, Integer.parseInt(port), "downloadFile",
                    fname, fpath, newFsize);

            //接收验证结果
            ReceiveBean crb = new ReceiveBean("downloadFile", null,
                    null, this, csb);
        ...
        private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            csb = new SendBean(null, 0, "deleteFile", fname);
            //cb.DeleteFileInfo(fname);

            //接收验证结果
            ReceiveBean crb = new ReceiveBean("deleteFile", null, null,
                    this, csb);
        ...
        public void ProcessQuery(int type) {
            // 将数据传递给ClientBean
            SendBean csb = new SendBean(null, 0, "queryFile",
                    jTextFieldKeyWord.getText(), username, type + "");

            //接收验证结果
            ReceiveBean crb = new ReceiveBean("queryFile", null, null,
                    this, csb);
        }
        ...
        private void uploadButtonActionPerformed(java.awt.event.ActionEvent evt) {
            ...
            if (file != null) {
                ...
                SendBean csb = null;
                //用户名和密码传给服务器,进行登录验证
                csb = new SendBean(null, 0, "uploadFile", fileName, sb
                        .toString(), fileLength + "K", username);
                //csb.SubmitFileInfo(fileName, sb.toString(), fileLength + "K",username);

                //接收验证结果
                ReceiveBean crb = new ReceiveBean("uploadFile", null,
                        null, this, csb);
