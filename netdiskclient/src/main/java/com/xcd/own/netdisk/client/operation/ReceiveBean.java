...
import com.xcd.own.netdisk.client.gui.LoginJFrame;
import com.xcd.own.netdisk.client.gui.MainJFrame;
import com.xcd.own.netdisk.client.gui.RegisterJFrame;
import com.xcd.own.netdisk.client.gui.filevector.FileInfoModel;
 ...
 */
public class ReceiveBean extends Thread {
    private LoginJFrame ulf;
    ...
    private ObjectInputStream sin;  //保存ClientSendBean的IO对象，用于接受反馈数据
    private ObjectOutputStream sout;

    public ReceiveBean(String requestType, LoginJFrame ulf, RegisterJFrame rf, MainJFrame mjf, SendBean sendBean) {
        this.sendBean = sendBean;
        this.sin = sendBean.getIn();
        this.sout = sendBean.getOut();
    ...
    public LoginJFrame getUlf() {
        return ulf;
    }

    public void setUlf(LoginJFrame ulf) {
        this.ulf = ulf;
    }
    ...
    public SendBean getCsb() {
        return sendBean;
    }

    public void setCsb(SendBean sendBean) {
        this.sendBean = sendBean;
    }
        ...
        if (dp != null) {
            if (dp.getResult() != null) {
                ...
                if ("success".equals(dp.getResult())) {
                    ...
                    new MainJFrame(sendBean.getPara()[0], sendBean.getPara()[2], Integer.parseInt(sendBean.getPara()[3]));
                } else if ("failed".equals(dp.getResult())) {
